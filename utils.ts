...
export function make_signing_url (opts: {
...
}, endpoint = 'https://sign-poc.js.org') {

    const params = new URLSearchParams(opts).toString();

    return endpoint.concat('/auth', '#', params);
...
export const callback_redirect = v.pipeAsync(
...
export function evaluate <
        ...
        T extends v.InferOutput<typeof callback_redirect>
